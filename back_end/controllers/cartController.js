...
module.exports = {
    ...
    getCart: (req, res) => {
        let selectQuery = `select c.id_cart,(product_price * cart_qty) as total, u.id_user, u.username, p.id_product, p.product_name, p.product_price, c.cart_qty, p.unit, p.product_image
        from cart c
